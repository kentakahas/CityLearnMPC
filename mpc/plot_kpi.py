...
def plot_district_kpis(envs: Mapping[str, CityLearnEnv]) -> plt.Figure:
    ...
    figsize = (7.0*column_count, 0.3*env_count*kpi_count*row_count)
...
def plot_actions(actions_list: List[List[float]], env: CityLearnEnv, title: str) -> plt.Figure:
